...
public class TwentyFifthArabicControl : MonoBehaviour
{
    ...
    public void FillSentence()
    {
        switch (counter)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                sentenceImages[4].fillAmount += speed5;
                if (sentenceImages[4].fillAmount >= 1)
                {
                    counter++;
                }
                break;
            case 5:
                sentenceImages[5].fillAmount += speed6;
                ...
                break;
            case 6:
                sentenceImages[6].fillAmount += speed7;
                if (sentenceImages[6].fillAmount >= 1)
                {
                    counter++;
                }
                break;
